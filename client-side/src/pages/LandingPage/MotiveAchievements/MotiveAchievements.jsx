    ...
    const objectives = [
        {
            ...
            "description": "We strive to create a close-knit community of like-minded individuals with honest mindset, who share a passion for coding. Through regular meetings, workshops, and social events, we encourage members to interact, collaborate, and forge meaningful connections, fostering an inclusive and supportive coding culture."
        },
        {
            "title": "Collaboration and Knowledge Sharing",
            "description": "We believe in the power of teamwork and the benefits of sharing knowledge. Our club facilitate opportunities for members to collaborate on coding projects, solve programming challenges, and exchange ideas and expertise. We organize coding sessions, provide programming exercises, and coding bootcamps to encourage collaboration and foster a spirit of learning together."
        },
        {
            "title": "Personal Growth and Skill Development",
            "description": "We are committed to help our members grow and excel in their coding abilities. By organizing workshops, seminars, and guest speaker sessions, we provide opportunities for members to learn new programming languages, explore cutting-edge technologies, and develop industry-relevant skills. Through mentorship programs and peer-to-peer learning, we create an environment where everyone can enhance their coding prowess."
        },
        {
            "title": "Promotion of Competitive Programming",
            "description": "Recognizing the value of competitive programming as a means to sharpen problem-solving skills and improve algorithmic thinking, we actively promote this aspect within our club. We organize coding competitions, encourage our member to participate in external coding contests, and provide resources and guidance to help our members to excel in competitive programming."
        },
        {
            "title": "Our Coding Club's Mission",
            "description": "Through these objectives, Our Coding Club create a vibrant coding community in the college that empowers its members to grow, learn, and succeed together, while also making a meaningful contribution to the broader coding community."
        }
    ]
